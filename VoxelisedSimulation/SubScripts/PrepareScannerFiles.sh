...
if [ $ScannerType = "D690" ]; then
	...
	cp -vp $D690_DIR/root_header_template.hroot Templates/root_header_template.hroot
	cp -vp $D690_DIR/STIRScanner_D690_full_segment.hs Templates/STIR_scanner.hs
	...
	cp -vp $mMR_DIR/root_header_template.hroot Templates/root_header_template.hroot
	cp -vp $mMR_DIR/STIR_scanner.hs Templates/STIR_scanner.hs
