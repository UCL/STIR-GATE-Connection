...
if [ $# != 3 ]; then
	echo "Usage: EstimateGATESTIRNorm.sh OutputFilename MeasuredData FOVCylindricalActivityVolumeFilename"
	exit 1
fi 
...
apply_normfactors3D $OutputFilename $factors $model_data 1 $outer_iters $eff_iters
