...
SourcePositions=$( SubScripts/get_source_position.sh $ActivityFilename 2>/dev/null ) 
...
AttenuationTranslations=$( SubScripts/get_attenuation_translation.sh $AttenuationFilename 2>/dev/null ) 
